...
import { currencyEquals, ETHER, JSBI, TokenAmount, WNATIVE, MINIMUM_LIQUIDITY } from '@smartdev1990/dex-sdkv3'
import {
  Button,
  Text,
  AddIcon,
...
import { RICE } from 'config/constants/tokens'
...
export default function AddLiquidity() {
  ...
  const [currencyIdA, currencyIdB] = router.query.currency || ['BNB', RICE[chainId]?.address]
