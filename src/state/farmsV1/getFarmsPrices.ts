...
const getFarmBaseTokenPrice = (
  ...
  if (farm.quoteToken.symbol === briseToken.busd.symbol) {
    return hasTokenPriceVsQuote ? new BigNumber(farm.tokenPriceVsQuote) : BIG_ZERO
  }

  if (farm.quoteToken.symbol === briseToken.wbnb.symbol) {
  ...
  if (quoteTokenFarm.quoteToken.symbol === briseToken.wbnb.symbol) {
  ...
  if (quoteTokenFarm.quoteToken.symbol === briseToken.busd.symbol) {
