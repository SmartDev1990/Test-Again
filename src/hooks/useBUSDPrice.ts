import { Currency, currencyEquals, JSBI, Price, WNATIVE } from '@smartdev1990/dex-sdkv3'
import { RICE, BUSD } from 'config/constants/tokens'
...
export const useCakeBusdPrice = (): Price | undefined => {
  const { chainId } = useActiveWeb3React()
  const cakeBusdPrice = useBUSDPrice(RICE[chainId])
